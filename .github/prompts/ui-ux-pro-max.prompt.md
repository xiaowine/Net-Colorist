...
### Step 4: Stack Guidelines (Default: vue)

Get implementation-specific best practices. If user doesn't specify a stack, **default to `vue`**.

```bash
python3 .shared/ui-ux-pro-max/scripts/search.py "<keyword>" --stack vue
```
...
| `vue`             | Composition API, Pinia, Vue Router (DEFAULT)          |
...
```bash
python3 .shared/ui-ux-pro-max/scripts/search.py "layout responsive form" --stack vue
```
